...
DROP TABLE arca CASCADE CONSTRAINTS;
...
CREATE TABLE festivities (
    ...
    FOREIGN KEY (festivities_area) REFERENCES arca(area_id)
);
...
CREATE TABLE specialties (
    ...
    FOREIGN KEY (specialties_area) REFERENCES arca(area_id)
);
...
CREATE TABLE users (
    ...
    area_id INT,
    theme_id INT,
    FOREIGN KEY (area_id) REFERENCES arca(area_id),
